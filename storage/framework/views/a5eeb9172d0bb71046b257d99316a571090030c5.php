              ...
              <li class="dropdown">
                  <div class="btn-group">
                    ...
                    <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Action <span class="caret"></span>
                      ...
                      <button class="btn btn-primary"><a class="main" href="<?php echo e(url('/home')); ?>"><?php echo e(Auth::user()->name); ?></a></button>
                      <?php else: ?>
              ...
              <div class="container">
                  <div class="row">
                      <div class="col-lg-6">
                          ...
                          <button class="btn btn-primary uppercase"><a href="<?php echo e(route('register')); ?>">Get Started</a></button>
                      </div>
                      <div class="header-img col-lg-6 ">
                          <img src="<?php echo e(asset('images/pensioen-voor-je-medewerkers-32eedc88.png')); ?>" />
                      </div>
                  </div>
              </div>
          </div>
          ...
          <div class="overly">
              <div class="container">
                  ...
                  <h1>Getting started is easy.</h1>
                    <button class="btn btn-primary"><a href="<?php echo e(route('register')); ?>">Sign up for free</a></button>
              </div>
          </div>
      </div>
      <!--Start Can Do Section-->
              ...
              <div class="row">
                  ...
                  <div class="col-md-8">
                      ...
                      <p class="lead">Hardware project, Software project, Archtictur project, any project naeed to management by true way —that’s where we come in.</p>
                       <button class="btn btn-primary"><a href="<?php echo e(route('register')); ?>">Start Your Project</a></button>
                  </div>
              </div>
          </div>
      </div>
...
<?php /**PATH C:\Users\adones\Downloads\PMS\resources\views/welcome.blade.php ENDPATH**/ ?>