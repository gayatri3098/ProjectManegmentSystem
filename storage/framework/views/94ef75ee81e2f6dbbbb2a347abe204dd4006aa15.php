...
if (isset($messageCache)) { $message = $messageCache; }
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="text" class="form-control <?php if ($errors->has('user_name')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('user_name'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="user_name">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\adones\Downloads\Laravel Projects\Unfinish\Project-System-Laravel\resources\views/auth/register.blade.php ENDPATH**/ ?>